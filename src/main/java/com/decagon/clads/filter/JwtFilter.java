...
//        log.info("jwt filter");
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        ...
        return Pattern.compile("/api/v1/(artisan/register|customer/register|confirm|login|login/google|home|download/image/*|message|conversations)").matcher(path).find();
    }
}
